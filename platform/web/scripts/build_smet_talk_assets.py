...
def build_slide4() -> str:
    ...
    body = [
        ...
        f'<image href="{ring_compare}" x="620" y="410" width="876" height="386" preserveAspectRatio="xMidYMid meet"/>',
        card(620, 808, 876, 72, 18, "#f5efe4"),
        text(650, 852, "One regime stays broad; another keeps both an early branch and a delayed branch visible.", 20, 500, SOFT),
    ]
    return svg_doc("".join(body))
