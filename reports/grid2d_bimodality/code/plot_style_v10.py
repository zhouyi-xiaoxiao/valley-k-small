#!/usr/bin/env python3
"""Shared Fig.3-style drawing utilities for v10."""
    ...
    *,
    ...
    if fine_grid:
        for k in range(x0, x1):
            ax.axvline(k + 0.5, color="0.94", lw=0.4, zorder=0)
        for k in range(y0, y1):
            ax.axhline(k + 0.5, color="0.94", lw=0.4, zorder=0)
