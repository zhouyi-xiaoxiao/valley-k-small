...
- Cross-model:
  ...
  - 负责仓库里唯一活跃的计算方法比较主稿；历史 full-FPT 公平口径仅以内嵌附录保留
...
| `research/reports/luca_vs_recursion_unified_benchmark` | `research/reports/luca_vs_recursion_unified_benchmark/manuscript/luca_vs_recursion_unified_benchmark_cn.pdf`, `research/reports/luca_vs_recursion_unified_benchmark/manuscript/luca_vs_recursion_unified_benchmark_en.pdf` | `research/reports/luca_vs_recursion_unified_benchmark/manuscript/luca_vs_recursion_unified_benchmark_cn.tex`, `research/reports/luca_vs_recursion_unified_benchmark/manuscript/luca_vs_recursion_unified_benchmark_en.tex` |
