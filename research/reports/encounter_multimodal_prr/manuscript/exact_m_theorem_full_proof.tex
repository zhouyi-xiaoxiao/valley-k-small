% Reader-facing complete proof fragment for inclusion in
% encounter_multimodal_prr_supplement.tex.  This file deliberately contains
% no document class, package import, bibliography, or end-document command.
