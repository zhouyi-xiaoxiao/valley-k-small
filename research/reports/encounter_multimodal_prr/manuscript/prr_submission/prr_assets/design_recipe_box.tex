...
% SUGGESTED PLACEMENT: Discussion (Sec.~\ref{sec:discussion}), referenced
%   as ``Table~\ref{tab:design-recipe} summarizes the construction as a
%   checkable procedure.''
...
small (late peaks widen as $\sigma/x'(t_j)$).\\[3pt]
...
connected topology-retention threshold uniform over the declared allocation
