#!/usr/bin/env python3
"""FPT plots for v8 (multiscale + bimodality proof)."""
...
from plot_style_v8 import apply_style_v8, detect_bimodality, save_clean
