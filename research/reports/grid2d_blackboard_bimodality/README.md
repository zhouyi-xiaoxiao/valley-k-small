...
This report follows the figure/layout style of `reports/grid2d_bimodality/` and `reports/grid2d_reflecting_bimodality/`, and currently focuses on the single case where the start/target are placed at the wall endpoints (case Z).
...
- `reports/grid2d_blackboard_bimodality/config/A_geometry_U_detour.json`
- `reports/grid2d_blackboard_bimodality/config/B_parallel_lanes_doors.json`
- `reports/grid2d_blackboard_bimodality/config/C_wall_loop_conveyor.json`
- `reports/grid2d_blackboard_bimodality/config/Z_screenshot_wall_endpoints.json`
- `reports/grid2d_blackboard_bimodality/config/S_small_rect_endpoints.json`

## Screenshot scan
- `python3 reports/grid2d_blackboard_bimodality/code/screenshot_scan.py`
- Output: `reports/grid2d_blackboard_bimodality/outputs/screenshot_scan.json`
- Internals: implemented in `src/vkcore/grid2d/reflecting_blackboard/_screenshot_scan.py` using shared `model/scans/io` helpers.

## Outputs
- Figures: `reports/grid2d_blackboard_bimodality/figures/`
...
- Data: `reports/grid2d_blackboard_bimodality/data/Z_metrics.json`, `reports/grid2d_blackboard_bimodality/data/S_metrics.json`, `reports/grid2d_blackboard_bimodality/data/Z_scan.json`

## Report
- `reports/grid2d_blackboard_bimodality/grid2d_blackboard_bimodality_cn.pdf`
- `reports/grid2d_blackboard_bimodality/grid2d_blackboard_bimodality_en.pdf`
