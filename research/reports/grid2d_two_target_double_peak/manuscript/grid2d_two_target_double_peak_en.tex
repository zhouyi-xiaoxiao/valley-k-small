...
\begin{itemize}
  \item \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/data/case\_summary.json}
  \item \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/data/sparse\_testset\_results.json}
  \item \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/data/scan\_w2\_skip2.csv}, \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/data/scan\_w2\_skip2.json}
  \item \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/outputs/C1\_fpt.csv} -- \texttt{.../C4\_fpt.csv}
  \item \texttt{research/reports/grid2d\_two\_target\_double\_peak/artifacts/outputs/S02\_external\_fpt.csv}, \texttt{.../S03\_external\_fpt.csv}
\end{itemize}
