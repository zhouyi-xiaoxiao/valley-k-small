...
python3 research/reports/ring_valley_dst/code/bimodality_flux_scan.py --help
python3 research/reports/ring_valley_dst/code/dst_shortcut_usage_mc.py --help
python3 research/reports/ring_valley_dst/code/second_peak_scan.py --help
python3 research/reports/ring_valley_dst/code/second_peak_shortcut_usage_mc.py --help
```

## Build PDFs
```bash
cd research/reports/ring_valley_dst
