...
def run_python_audit() -> dict[str, Any]:
    ...
    for py in sorted((REPO_ROOT / "src").glob("**/*.py")):
...
def main() -> int:
    ...
    parser.add_argument("--full", action="store_true", help="Full mode: audit all TeX files under reports/*.")
