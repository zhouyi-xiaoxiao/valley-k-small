...
CHAPTER_BLUEPRINT: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary_en": "Introduce lazy ring dynamics, baseline inversion logic, and the cleanest reference behavior before shortcuts.",
        "summary_cn": "建立 lazy ring 动力学、反演主线与引入 shortcut 前的基准行为。",
        "intro_en": [
            "Ring models provide a compact setting for isolating drift, waiting probability, and spectral structure.",
            "This baseline chapter is intentionally conservative: it fixes reference behavior before adding shortcut perturbations.",
